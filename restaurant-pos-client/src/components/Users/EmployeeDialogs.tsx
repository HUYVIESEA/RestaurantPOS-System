        ...
        {!showPassword ? (
          ...
          <>
            ...
            <div className="p-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-700 flex justify-end gap-3">
              ...
              <button className="px-4 py-2 rounded-lg font-medium text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-600/30 transition-colors" onClick={onConfirm}>
                Reset mật khẩu
              </button>
            </div>
          </>
          ...
          <>
            ...
            <div className="p-6 space-y-4">
              <p className="text-blue-700 dark:text-blue-500 font-medium text-sm">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button 
                    className={`px-4 py-3 rounded-lg font-medium transition-colors border ${copied ? 'bg-blue-50 border-blue-200 text-blue-800 dark:bg-blue-900/30 dark:border-blue-900 dark:text-blue-500' : 'bg-white border-slate-300 text-slate-700 hover:bg-slate-50 dark:bg-slate-700 dark:border-slate-600 dark:text-slate-200 dark:hover:bg-slate-600'}`}
                    onClick={handleCopy}
                    title="Copy mật khẩu"
                  >
            ...
            <div className="p-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-700 flex justify-end">
              <button className="px-6 py-2 rounded-lg font-medium text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-600/30 transition-colors w-full" onClick={onCancel}>
                Đã lưu lại
              </button>
            </div>
          </>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4" onClick={onCancel}>
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-xl w-full max-w-md overflow-hidden border border-slate-200 dark:border-slate-700" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-700 flex justify-end gap-3">
          ...
          <button 
            className={`px-4 py-2 rounded-lg font-medium text-white transition-colors focus:ring-4 ${currentStatus ? 'bg-rose-600 hover:bg-rose-700 focus:ring-rose-500/30' : 'bg-blue-700 hover:bg-blue-800 focus:ring-blue-600/30'}`} 
            onClick={onConfirm}
          >
