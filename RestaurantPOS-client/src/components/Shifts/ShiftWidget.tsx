...
const ShiftWidget: React.FC = () => {
  ...
  if (!activeShift) {
    return (
      <div className="bg-blue-600 rounded-2xl shadow-lg mb-8 overflow-hidden text-white">
        {isStarting ? (
          <div className="p-6">
            <h3 className="text-xl font-bold mb-4">Mở ca làm việc mới</h3>
            <form onSubmit={handleStartShift} className="space-y-4">
              <div>
                <label className="block text-sm font-medium mb-1 text-blue-100">Tiền mặt đầu ca (VND) <span className="text-red-300">*</span></label>
                <input 
                  type="number" 
                  required
                  min="0"
              ...
              <div>
                <label className="block text-sm font-medium mb-1 text-blue-100">Ghi chú (Tuỳ chọn)</label>
                <input 
                  type="text" 
                  className="w-full px-4 py-2 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white/50"
              ...
              <div className="flex gap-3 pt-2">
                <button 
                  type="submit" 
                  className="px-6 py-2 bg-white text-blue-700 font-bold rounded-xl shadow-sm hover:bg-blue-50 transition-colors"
                >
                  Bắt đầu ca
                </button>
                <button 
          ...
          <div className="p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-100 mt-1">Bạn cần mở ca làm việc để bắt đầu thực hiện thanh toán và quản lý đơn hàng.</p>
              </div>
            </div>
            <button 
              onClick={() => setIsStarting(true)}
              className="px-6 py-3 bg-white text-blue-700 font-bold rounded-xl shadow-md hover:bg-blue-50 transition-colors flex items-center gap-2 whitespace-nowrap"
            >
  ...
  // Active Shift State
  return (
    <div className="bg-white dark:bg-slate-800 border border-blue-200 dark:border-blue-900/50 rounded-2xl shadow-sm mb-8 overflow-hidden relative">
      <div className="absolute top-0 left-0 w-1 h-full bg-blue-600"></div>
      
      {isClosing ? (
        <div className="p-6">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-100 dark:border-slate-700">
            <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-500 flex items-center justify-center">
          ...
          <form onSubmit={handleCloseShift} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-2">
              ...
              <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-100 dark:border-blue-900/30">
                <p className="text-sm text-blue-700 dark:text-blue-500 mb-1">Tiền mặt dự kiến (Hệ thống tính)</p>
                <p className="font-bold text-xl text-blue-800 dark:text-blue-300">{formatCurrency(activeShift.expectedCash || activeShift.startingCash)}</p>
              </div>
            </div>
            ...
            <div>
              ...
              <input 
                ...
                required
                min="0"
                className="w-full px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-600"
            ...
            <div className="flex gap-3 pt-4">
              <button 
                type="submit" 
                className="px-6 py-2 bg-blue-700 text-white font-bold rounded-xl shadow-sm hover:bg-blue-800 transition-colors"
              >
                Xác nhận đóng ca
              </button>
              <button 
        ...
        <div className="p-6 flex flex-col lg:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-4 w-full lg:w-auto">
            <div className="w-14 h-14 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-500 flex items-center justify-center text-2xl shrink-0">
              <i className="fas fa-clock-rotate-left"></i>
            </div>
            <div>
              <div className="flex items-center gap-2 mb-1">
                <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">Đang trong ca làm việc</h3>
                <span className="px-2 py-0.5 text-xs font-bold bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-500 rounded-md">ACTIVE</span>
              </div>
          ...
          <div className="flex items-center justify-between w-full lg:w-auto gap-6 bg-slate-50 dark:bg-slate-900/50 p-3 rounded-xl border border-slate-100 dark:border-slate-700/50">
            ...
            <div className="text-center px-4">
              ...
              <p className="font-bold text-blue-700 dark:text-blue-500">{formatCurrency(activeShift.expectedCash || activeShift.startingCash)}</p>
            </div>
            <button 
